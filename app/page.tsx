...
const IG_HREF = 'https://instagram.com/axel.gz97'
...
export default async function HomePage() {
  ...
  return (
    <div className="relative bg-zinc-950">
      ...
      {/* ── Hero ───────────────────────────────────────────────────────────── */}
      <section id="inicio" className="relative flex min-h-[100dvh] flex-col items-center justify-center overflow-hidden px-6 text-center">
        <div
          className="pointer-events-none absolute inset-0 opacity-[0.0]"
          aria-hidden="true"
        />
        ...
        <div className="mx-auto max-w-lg">
          ...
          <div className="mt-8 text-center">
            <a
              ...
              className="inline-flex items-center gap-2.5 rounded-xl bg-gradient-to-r from-[#f09433] via-[#e6683c] to-[#bc1888] px-6 py-3 text-sm font-semibold text-white transition-opacity hover:opacity-90"
            >
      ...
      <footer className="bg-zinc-950 px-6 pb-8 pt-16">
        <div className="mx-auto max-w-lg">
          <div className="mb-10 flex flex-col items-center gap-3">
            ...
            <p className="text-[11px] font-medium tracking-widest text-zinc-500">Tu look, Tu Regla</p>
          </div>
